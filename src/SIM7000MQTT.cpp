...
{
    setup_mqtt_cmds_ = std::vector<std::string> { AT AT_ENDL,
    ...
    enable_mqtt_cmds_ = std::vector<std::string> { AT_CNACT_ON AT_ENDL, AT_SMCONN AT_ENDL };

    disable_mqtt_cmds_ = std::vector<std::string> { AT_SMDISC AT_ENDL, AT_CNACT_OFF AT_ENDL };

    gnss_cmds_ = std::vector<std::string> { AT_CGNSPWR_ON AT_ENDL, AT_CGNSINF AT_ENDL, AT_CGNSPWR_OFF AT_ENDL };
}
